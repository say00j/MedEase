          ...
          {!loading && pat && (
            <>
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: 18, color: "#7F8C8D", maxWidth: 420 }}>
                    Welcome back to your MedEase health dashboard. Stay on top
                    of your wellbeing.
                  </p>
                </div>
              ...
              >
                {[
                  ["3", "Appointments"],
                  [med.blood_group || "—", "Blood Group"],
                  [med.height ? med.height + " cm" : "—", "Height"],
                ].map(([num, label]) => (
                  <div
                    key={label}
                    style={{
                  ...
                  >
                    <div style={{ fontSize: 36, fontWeight: 800, color: blue }}>
                      {num}
                    </div>
                    <div
                      style={{
